...
/* express, which this time is a function that is used to create an express application stored in the app variable: */
const app = express();
...
const { PORT } = process.env; // We are using dotenv and the port is defined in the .env file,... || 3001;
app.listen(PORT, () => {
